...
class ControlRightPsSingleIgor extends React.Component {
  constructor(props) {
    super(props);
        ...
        <Card style={{ padding: 12}} >
          ...
          <Grid   container
            ...
            <Grid item xs={2}  >
              ...
              <ActionButton pv={'pva://'+system.devices.device.deviceName+":put-pulseA"} macros={this.props['macros']}   actionValue={"1"}
                actionString={"On"}/>
            ...
            <ActionButton pv={'pva://'+system.devices.device.deviceName+":put-pulseB"} macros={this.props['macros']}   actionValue={"1"}
...
export default withStyles(styles,{withTheme:true})(ControlRightPsSingleIgor)
