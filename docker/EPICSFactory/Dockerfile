...
# Add MDSplus-EPICS Interface 

# RUN mkdir /epics/staging
# ADD ./tools/mdsplus/epics /epics/mdsplus/epics
# RUN cp -R /epics/mdsplus/epics/mdsrecords/* /epics/staging/mdsplusSup/mdsplusSupApp/src
