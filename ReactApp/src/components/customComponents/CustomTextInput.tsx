...
const CusromTextInputComponent = (props) => {
...
/**
 * The CusromTextInput Component is a wrapper on the Material-UI contained TextField component.
...
const CusromTextInput = ({
  ...
  showTooltip = false,
  ...others
}: CusromTextInputProps) => {
  return (
    <Widget
      {...others}
      component={CusromTextInputComponent}
      pvs={undefined}
      debug={debug}
...
/**
 * Props for the CusromTextInput component.
 */
interface CusromTextInputProps {
...
export default CusromTextInput;
