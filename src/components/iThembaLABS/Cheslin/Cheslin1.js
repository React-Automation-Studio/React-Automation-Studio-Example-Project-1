...
class Cheslin1 extends React.Component {
  constructor(props) {
    super(props);
    this.state={
      value: 0,
...
return (
  ...
  <React.Fragment>
            ...
            <Grid item >
              ...
              <Grid container spacing={2} alignItems={'stretch'} direction={'row'} justify={'flex-start'}>
                <Grid item xs={12} lg={4}>
                  <TextInput   pv='pva://$(device):frequency' macros={{'$(device)':'testIOC'}}    usePvUnits={true} usePrecision={true} usePvLabel={true}/>
                </Grid>
                <Grid item xs={12} lg={4}>
    ...
    <AppBar className={classes.body1} style={{position:'fixed',bottom:0,top:'auto'}} color='inherit'>
      ...
      export default withWidth()(withStyles(styles,{withTheme:true})(Cheslin1));
